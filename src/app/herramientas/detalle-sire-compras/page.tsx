...
export const metadata = { title: "Detalle SIRE — Compras (RCE) — Radar Tributario" };
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold text-slate-800">Detalle SIRE — Compras (RCE)</h1>
        <p className="text-sm text-slate-500">
          Extrae el detalle de la propuesta de compras (RCE) comprobante por comprobante desde la
          API oficial de SUNAT, y descárgalo en Excel.
        </p>
      </div>
      <DetalleSireTool clientes={min} tipo="compras" />
    </div>
  );
}
