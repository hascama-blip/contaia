...
export const metadata = { title: "Estado de cuenta (PDF) → Excel — Radar Tributario" };
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold text-slate-800">Estado de cuenta (PDF) → Excel</h1>
        <p className="text-sm text-slate-500">
          Convierte el PDF del estado de cuenta del banco a un Excel con la estructura de conciliación,
